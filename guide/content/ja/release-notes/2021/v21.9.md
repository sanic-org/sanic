...
This is the third release of the version 21 [release cycle](../../organization/policies.md#release-schedule). バージョン21は、12月の長期サポートバージョンリリースで「確定」されます。
...
バージョン [21.3](./v21.3.md) で [signals](../../guide/advanced/signals.md) が導入されました。 Sanicはコードベース内からシグナルイベントを**送信**します。 これにより、開発者は以前よりもずっと近いレベルでリクエスト/レスポンスサイクルをフックすることができます。
