...
This is the first release of the version 22 [release cycle](../../organization/policies.md#release-schedule). すべての標準SCOライブラリが同じリリースサイクルに入り、同じバージョンのパターンに従います。 これらのパッケージは以下のとおりです:
