...
This is the second release of the version 23 [release cycle](../../organization/policies.md#release-schedule). 何か問題が発生した場合は、 [GitHub](https://github.com/sanic-org/sanic/issues/new/choose) にご注意ください。
...
より詳しい議論については、[custom typed application](../../guide/basics/app.md#custom-typed-application) と [custom typed request](../../guide/basics/app.md#custom-typed-request)を参照してください。
