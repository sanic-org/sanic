...
这是版本 21 的第三次版本[发行周期](../../organization/policies.md#release-schedule)。 版本21将在12月份长期支持版本发布时“最后完成”。
...
Version [21.3](./v21.3.md) introduced [signals](../../guide/advanced/signals.md). 现在，Sanic 调度事件**来自codebase** 本身。 这意味着开发人员现在有能力将请求/响应周期绑定到比以往更接近的水平。
