...
这是版本 22 的最后版本[发行周期](../../organization/policies.md#release-schedule)。 因此，这是一个 **长期支持** 发布，并将按照 [policies]的说明提供支持(../../org/policies.md#long-term support-v-interim-releases)。
