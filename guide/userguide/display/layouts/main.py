...
from userguide.display.layouts.elements.footer import do_footer
from userguide.display.layouts.elements.navbar import do_navbar
from userguide.display.layouts.elements.sidebar import do_sidebar
