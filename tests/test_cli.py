...
# def starting_line(lines: List[AnyStr]):
#     for idx, line in enumerate(lines):
#         if line.strip().startswith(b"Sanic v"):  # type: ignore
#             return idx
#     return 0


# def read_app_info(lines: List[AnyStr]):
#     for line in lines:
#         if line.startswith(b"{") and line.endswith(b"}"):  # type: ignore
...
#     ),
# )
# def test_num_workers(num: int, cmd: Tuple[str], capsys):
#     command = ["sanic", "fake.server.app", *cmd]
